...
namespace LearningPlatformApi.Migrations
{
    ...
    [Migration("20260414155200_NullabeFKPageid")]
    partial class NullabeFKPageid
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategoryEntityCourseEntity", b =>
                {
                    ...
                    b.Property<string>("CategoriesTypeCode")
                        .HasColumnType("text");

                    b.Property<string>("CategoriesValueCode")
                        .HasColumnType("text");

                    b.HasKey("CoursesId", "CategoriesTypeCode", "CategoriesValueCode");

                    b.HasIndex("CategoriesTypeCode", "CategoriesValueCode");
            ...
            modelBuilder.Entity("CategoryEntityCourseEntity", b =>
                {
                    ...
                    b.HasOne("LearningPlatformApi.Persistence.Entities.CategoryEntity", null)
                        .WithMany()
                        .HasForeignKey("CategoriesTypeCode", "CategoriesValueCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("LearningPlatformApi.Persistence.Entities.ModuleEntity", b =>
                {
                    b.HasOne("LearningPlatformApi.Persistence.Entities.CourseEntity", "Course")
                        .WithMany("Modules")
